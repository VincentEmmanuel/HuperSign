  ...
  return match(state)
    ...
    .with(EMAIL_VERIFICATION_STATE.VERIFIED, () => (
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          <div className="mt-1 mr-4 hidden md:block">
            <CheckCircle2 className="h-10 w-10 text-orange-500" strokeWidth={2} />
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>Your email has been successfully confirmed! You can now use all features of HuperSign.</Trans>
            </p>
      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>Your email has already been confirmed. You can now use all features of HuperSign.</Trans>
            </p>
